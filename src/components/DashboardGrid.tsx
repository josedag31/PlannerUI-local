    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {visibleItems.map((item, index) => (
          ...
          >
            {/* El arrastre nativo vive en un div normal, no en el motion.div:
                Motion define sus propios manejadores de arrastre y sus tipos
                chocan con los del drag&drop de HTML5. */}
            <div
              draggable={editMode}
              onDragStart={(e) => {
