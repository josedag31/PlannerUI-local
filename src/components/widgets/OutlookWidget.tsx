import type { OutlookSummary } from "@/lib/microsoftData";

export default function OutlookWidget({ summary }: { summary: OutlookSummary | null }) {
  ...
  return (
    <div>
      <p className="text-sm font-medium mb-2">{summary.unreadCount} sin leer</p>
